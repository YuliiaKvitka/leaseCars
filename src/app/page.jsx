...
{/* --------------------------------------------- */}
      ...
      <section className={styles.video} >
        <div className="container">
          ...
          <div  className={styles.video__wrapper}><iframe className={styles.video__content} width="1000" height="500" src="https://www.youtube.com/embed/-KkY8Hon2nA?si=Fp33lQ5kECBfrXJj&amp;controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></div>
        </div>
      </section>
      {/* ------------------------------------------- */}
      <section className={styles.important}>
        <div className="container">
          ...
          <div className={styles['important__wrapper']}>
